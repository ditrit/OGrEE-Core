...
var dfas = []dfa{
	...
	// cd|pwd|clear|grep|ls
	{[]bool{false, false, false, false, false, false, true, true, false, false, true, true, false, false, false, true}, []func(rune) int{ // Transitions
		func(r rune) int {
			switch r {
			case 97:
				return -1
...
OUTER0:
	for {
		...
		case 14:
			{
				println("We got TOKEN_BASHTYPE")
				return TOKEN_BASHTYPE
			}
		case 15:
			{
