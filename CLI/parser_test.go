...
var commandsMatching = map[string]node{
	...
	"${toto}/tata:separators+=name@[1., 2.]@[1., 2.]@wireframe": &updateObjNode{testPath, "separators+", []node{&valueNode{"name"}, vec2(1., 2.), vec2(1., 2.), &valueNode{"wireframe"}}, false},
	"${toto}/tata:separators-=name":                             &updateObjNode{testPath, "separators-", []node{&valueNode{"name"}}, false},
	"${toto}/tata:pillars+=name@[1., 2.]@[1., 2.]@2.5":          &updateObjNode{testPath, "pillars+", []node{&valueNode{"name"}, vec2(1., 2.), vec2(1., 2.), &valueNode{"2.5"}}, false},
	"${toto}/tata:pillars-=name":                                &updateObjNode{testPath, "pillars-", []node{&valueNode{"name"}}, false},
