...
var (
	...
	yyXLAT = map[int]int{
		...
		57381: 4,  // P (7x)
		57374: 5,  // E (3x)
		57349: 6,  // TOKEN_BLDG (3x)
		57352: 7,  // TOKEN_DEVICE (3x)
		57351: 8,  // TOKEN_RACK (3x)
		57350: 9,  // TOKEN_ROOM (3x)
		57348: 10, // TOKEN_SITE (3x)
		57364: 11, // TOKEN_SLASH (3x)
		57353: 12, // TOKEN_SUBDEVICE (3x)
		57354: 13, // TOKEN_SUBDEVICE1 (3x)
		57347: 14, // TOKEN_TENANT (3x)
	...
	yyParseTab = [56][]uint8{
		...
		{39},
		{38},
		{5: 96, 77, 80, 79, 78, 76, 12: 81, 82, 75},
		{35, 69, 4: 93, 94, 77, 80, 79, 78, 76, 12: 81, 82, 75},
		// 10
		{1: 69, 85, 90, 91},
		{5: 74, 77, 80, 79, 78, 76, 12: 81, 82, 75},
		{8, 71, 4: 72},
		{5, 65, 4: 66},
		{9, 64},
		// 15
