...
var (
	...
	yyParseTab = [57][]uint8{
		// 0
		{16: 57, 45, 47, 50, 48, 49, 46, 44, 55, 58, 51, 54, 62, 30: 61, 52, 59, 56, 60, 53},
		{43},
		{42},
		{41},
		{40},
		...
		{38},
		{37},
		{5: 96, 76, 79, 78, 77, 75, 80, 81, 74},
		{34, 5: 93, 76, 79, 78, 77, 75, 80, 81, 74},
		// 10
		{5: 89, 76, 79, 78, 77, 75, 80, 81, 74},
		{5: 73, 76, 79, 78, 77, 75, 80, 81, 74},
		{8, 70, 4: 71},
		{5, 64, 4: 65},
		{9, 63},
		// 15
	...
	case 10:
		{
			...
			cmd.Disp(resMap(&yyS[yypt-0].s))
			cmd.SearchObjects(yyS[yypt-2].s, resMap(&yyS[yypt-0].s))
		}
	case 11:
		{
