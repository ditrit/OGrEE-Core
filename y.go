...
var (
	...
	yyXLAT = map[int]int{
		...
		57375: 25, // BASH (1x)
		57378: 26, // NT_CREATE (1x)
		57379: 27, // NT_DEL (1x)
		57380: 28, // NT_GET (1x)
		57381: 29, // NT_UPDATE (1x)
		57384: 30, // Q (1x)
		57385: 31, // start (1x)
		57370: 32, // TOKEN_CLR (1x)
		57367: 33, // TOKEN_DOC (1x)
		57363: 34, // TOKEN_EQUAL (1x)
		57366: 35, // TOKEN_EXIT (1x)
		57371: 36, // TOKEN_GREP (1x)
		57369: 37, // TOKEN_PWD (1x)
		57374: 38, // $default (0x)
		57345: 39, // error (0x)
	...
	yyParseTab = [66][]uint8{
		// 0
		{10: 62, 12: 58, 61, 15: 59, 63, 23: 64, 60, 65, 53, 56, 54, 55, 57, 52, 66, 70, 35: 69, 67, 68},
		{51},
		{50},
		{49},
		{48},
		...
		{47},
		{46},
		{8: 113, 106, 14: 109, 17: 108, 107, 105, 110, 111, 104},
		{43, 2: 81, 80, 79, 6: 102, 8: 103, 106, 14: 109, 17: 108, 107, 105, 110, 111, 104},
		{1: 97, 81, 80, 79, 6: 96, 95},
		// 10
		{23, 2: 81, 80, 79, 6: 94},
		{23, 2: 91, 80, 79, 6: 92},
		{23, 2: 88, 80, 79, 6: 89},
		...
		{11},
		{10},
		{9, 2: 77, 10: 72, 12: 73, 76, 15: 74, 71, 23: 78, 75},
		// 20
		{8},
		{7},
		{6},
