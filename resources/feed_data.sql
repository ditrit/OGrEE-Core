--- TENANT ---
-- tenant_id | tenant_name | tenant_parent_id | tenant_domain | tenant_description | tenant_color | main_contact | main_phone | main_email
INSERT INTO tenant (tenant_id, tenant_name, tenant_domain, tenant_description, 
tenant_color, main_contact, main_phone, main_email)
VALUES ('1','CEA','Reseau', '{Cant evaluate anything}', 'Red', 'Visit them', '000', 'cea@cea.com');

INSERT INTO tenant (tenant_id, tenant_name, tenant_domain, tenant_description, 
tenant_color, main_contact, main_phone, main_email)
VALUES ('2','Mitsubishi','Reseau', '{TriAge}', 'Red', 'website', '000', 'mitsubishi.com');
...
| site_description | site_orientation | usable_color 
...
| room_domain | room_description | room_pos_x_y 
