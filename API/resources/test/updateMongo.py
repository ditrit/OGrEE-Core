...
#PATCH or PUT
if len(sys.argv) > 1:
    if sys.argv[1] == "PATCH" or sys.argv[1] == "patch":
        print("Using Patch!")
        httpOP = "PATCH"
    else:
        print("PATCH not specified, using PUT")
        httpOP = "PUT"
...
payloadTable = {
    "tenant":{"name": "FISHER","parentId": None,"description": "Some Forsaken Joint\\nRotten Apple","domain": "999999","attributes": {  "color": "99",  "mainContact": "99",  "mainPhone": "999",  "mainEmail": "ghetto@ogree3D.com"}},
    ...
    "building":{"name": "Abandoned-Building","id": None,"parentId": PIDS["siteID"],"category": "999","description": "Wassup yo\\nGuess whos back","domain": "999","attributes": {    "posXY": "999",    "posXYUnit": "m",    "posZ": "999",    "posZUnit": "m",    "size": "999",    "sizeUnit": "m",    "height": "0",    "heightUnit": "m",    "nbFloors": "99"}},
    ...
    "room":{"name": "Abandoned Room","id": None,"parentId": PIDS["buildingID"],"category": "999","description": "999","domain": "999","attributes": {    "posXY": "999",    "posXYUnit": "m",    "posZ": "999",    "posZUnit": "m",    "template": "999",    "orientation": "-N-W",    "size": "999",    "sizeUnit": "m",    "height": "999",    "heightUnit": "m", "floorUnit":"m"}},
    "rack":{"name": "Abandoned Rack","id": None,"parentId": PIDS["roomID"],"category": "rack","description": "99\\n999\\n9999","domain": "Abandoned Rack","attributes": {    "posXY": "999",    "posXYUnit": "tile",    "size": "99",    "sizeUnit": "cm",    "height": "999",    "heightUnit": "U",    "template": "",    "orientation": "front",    "vendor": "999",    "type": "999",    "model": "999",    "serial": "999"}},
    "device":{"name": "Abandoned Device","id": None,"parentId": PIDS["rackID"],"category": "999","description": "Rack A01\\nThe original one\\n-3/-5\\nA0-Z9","domain": "99","attributes": {"posXY": "99","posXYUnit": "tile","size": "99","sizeUnit": "cm","height": "99","heightUnit": "U","template": "","orientation": "front","vendor": "99","type": "99","model": "99","serial": "99"}},
